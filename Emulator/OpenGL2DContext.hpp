// *****************************************************************************
    ...
    // On Emscripten, use the statically linked GL bindings (needed for LEGACY_GL_EMULATION).
    // GLAD dynamic lookup leaves fixed-pipeline entry points as null under WebGL.
